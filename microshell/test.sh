...
gcc -g -Wall -Werror -Wextra -DTEST_SH test.c -o microshell
printf "\e[1;36mTest\n\e[0m"
rm -f out.res leaks.res out
test_line /bin/ls
test_line /bin/cat test.c
test_line /bin/ls test.c
...
test_line /bin/ls ftest ";" /bin/ls ";" /bin/ls werwer ";" /bin/ls test.c ";" /bin/ls subject.fr.txt ";"
